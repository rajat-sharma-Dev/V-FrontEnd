...
const TOKEN_LIST = {
  ...
  ETH: {
    ...
    logo: "/tokens/eth.png",
    addresses: {
      1: "NATIVE", // Mainnet - ETH is native
      11155111: "NATIVE", // Sepolia - ETH is native
      84531: "NATIVE", // Sepolia Base - ETH is native
    },
    isNative: true,
  },
  MATIC: {
    ...
    addresses: {
      137: "NATIVE", // Polygon Mainnet - MATIC is native
      80001: "NATIVE", // Mumbai - MATIC is native
    },
    isNative: true,
  },
...
export const getSupportedTokens = (chainId) => {
  ...
  return Object.values(TOKEN_LIST).filter(token => 
